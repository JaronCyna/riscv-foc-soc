...
static inline Vector2D Prop(Vector2D err) {
...
static inline Vector2D Integral(Vector2D err, Vector2D last_int) {
...
static inline Vector2D System(Vector2D integral, Vector2D prop) {
